...
export default function PremiumFeaturesEditorRoute() {
  ...
  const [subheading, setSubheading] = useState(
    "Present the strongest benefits of your products in a cleaner grid with premium spacing and stronger structure.",
  );
  const [cardOneTitle, setCardOneTitle] = useState("Premium materials");
  const [cardOneText, setCardOneText] = useState(
    "Show quality and craftsmanship in a cleaner card layout that feels more premium.",
  );
  const [cardTwoTitle, setCardTwoTitle] = useState("Mobile-ready layout");
  const [cardTwoText, setCardTwoText] = useState(
    "Help shoppers scan benefits easily across desktop and mobile storefront layouts.",
  );
  const [cardThreeTitle, setCardThreeTitle] = useState("Fast setup flow");
  const [cardThreeText, setCardThreeText] = useState(
    "Give merchants a cleaner editing experience with better structure and visual control.",
  );
  ...
  const [iconTone, setIconTone] = useState("gold");
  ...
  const cards = [
    { title: cardOneTitle, text: cardOneText },
    { title: cardTwoTitle, text: cardTwoText },
    { title: cardThreeTitle, text: cardThreeText },
